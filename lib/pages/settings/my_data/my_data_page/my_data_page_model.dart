...
import 'my_data_page_widget.dart' show MyDataPageWidget;
import 'package:flutter/material.dart';
import 'package:flutter/services.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:provider/provider.dart';

class MyDataPageModel extends FlutterFlowModel<MyDataPageWidget> {
  ...
  // Model for AccontComponent component.
  late AccontComponentModel accontComponentModel;
  ...
  void initState(BuildContext context) {
    ...
    accontComponentModel = createModel(context, () => AccontComponentModel());
  }

  void dispose() {
    unfocusNode.dispose();
    profileHorizontalComponentModel.dispose();
    accontComponentModel.dispose();
  }
