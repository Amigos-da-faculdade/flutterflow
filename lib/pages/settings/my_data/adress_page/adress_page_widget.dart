...
class AdressPageWidget extends StatefulWidget {
  const AdressPageWidget({Key? key}) : super(key: key);

  @override
  _AdressPageWidgetState createState() => _AdressPageWidgetState();
}
              ...
              children: [
                ...
                Flexible(
                  child: Align(
                    ...
                    child: wrapWithModel(
                      model: _model.assetsComponentsModel,
                      updateCallback: () => setState(() {}),
                      child: AssetsComponentsWidget(),
                    ),
                  ),
                ),
              ],
